...
use FinanceDuo\Expenses\Infrastructure\Doctrine\AmountType;
use FinanceDuo\Expenses\Infrastructure\Doctrine\PaidAtType;
use FinanceDuo\Users\Infrastructure\Doctrine\EmailType;
use FinanceDuo\Users\Infrastructure\Doctrine\PasswordType;
use FinanceDuo\Users\Infrastructure\Doctrine\PercentageType;
use FinanceDuo\Users\Infrastructure\Doctrine\UsernameType;
use Shared\Infrastructure\Persistence\Doctrine\Types\CreatedAtType;
use Shared\Infrastructure\Persistence\Doctrine\Types\DescriptionType;
use Shared\Infrastructure\Persistence\Doctrine\Types\NameType;
use Shared\Infrastructure\Persistence\Doctrine\Types\UpdatedAtType;
use Shared\Infrastructure\Persistence\Doctrine\Types\UuidType;
...
return [
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'namespaces'    => [],
            'paths'         => [
                base_path('src/FinanceDuo/Groups/Infrastructure/Doctrine/'),
                base_path('src/FinanceDuo/Expenses/Infrastructure/Doctrine/'),
                base_path('src/FinanceDuo/UserGroups/Infrastructure/Doctrine/'),
                base_path('src/FinanceDuo/Users/Infrastructure/Doctrine/'),
            ],
    ...
    */
    'custom_types'               => [
        ...
        'amount'     => AmountType::class,
        'paid_at'    => PaidAtType::class,

        'percentage' => PercentageType::class,
